...
public partial class TmdtContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBaoCao).HasName("PK__BAO_CAO__3334D179FB362085");
        ...
        {
            entity.HasKey(e => e.MaChiTietDonHang).HasName("PK__CHI_TIET__8280DDB8B2E23CE1");
        ...
        {
            entity.HasKey(e => e.MaChiTietGioHang).HasName("PK__CHI_TIET__D8C4F0E7A53A8B5D");
        ...
        {
            entity.HasKey(e => e.MaChiTietKhuyenMai).HasName("PK__CHI_TIET__D6DAF54F1990275C");
        ...
        {
            entity.HasKey(e => e.MaChiTiet).HasName("PK__CHI_TIET__A5990A2201FC270D");
        ...
        {
            entity.HasKey(e => e.MaChiTietXuatKho).HasName("PK__CHI_TIET__E1A792A5E732B09A");
        ...
        {
            entity.HasKey(e => e.MaDanhMuc).HasName("PK__DANH_MUC__ACC6D9BB36F3E41C");
        ...
        {
            entity.HasKey(e => e.MaYeuThich).HasName("PK__DANH_SAC__99D274B48230816D");
        ...
        {
            entity.HasKey(e => e.MaDiaChi).HasName("PK__DIA_CHI___3BCAD161B4A1710E");
        ...
        {
            entity.HasKey(e => e.MaDonHang).HasName("PK__DON_HANG__A7174667F23B81F3");
        ...
        {
            entity.HasKey(e => e.MaGioHang).HasName("PK__GIO_HANG__16B948AB72AFE0D1");
        ...
        {
            entity.HasKey(e => e.MaHangSanXuaT).HasName("PK__HANG_SAN__891CE634389FE8E6");
        ...
        {
            entity.HasKey(e => e.MaKhuyenMai).HasName("PK__KHUYEN_M__91682CA17804E32B");
        ...
        {
            entity.HasKey(e => e.MaNhapKho).HasName("PK__NHAP_KHO__6874D7D8A9A7E5C9");
        ...
        {
            entity.HasKey(e => e.NhapChiTiet).HasName("PK__NHAP_KHO__AE1443ED0B5EB7D4");
        ...
        {
            entity.HasKey(e => e.MaPhuongThucGd).HasName("PK__PHUONG_T__DD4C335A939AEC12");
        ...
        {
            entity.HasKey(e => e.MaPhuongThuc).HasName("PK__PHUONG_T__31662E8170FAF5F6");
        ...
        {
            entity.HasKey(e => e.MaTonKho).HasName("PK__QUAN_LY___5CC9326D89AC93F8");
        ...
        modelBuilder.Entity<SanPham>()
            ...
            .WithOne(ct => ct.MaSanPhamNavigation)
            .HasForeignKey(ct => ct.MaSanPham);
            
        modelBuilder.Entity<SanPham>(entity =>
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SAN_PHAM__AEAADD69359BD171");
        ...
        {
            entity.HasKey(e => e.MaChiTietYeuThich).HasName("PK__SAN_PHAM__CC600104CF93BB80");
        ...
        {
            entity.HasKey(e => e.MaTk).HasName("PK__TAI_kHOA__2E62FB7C5190AE69");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__THANH_TO__D82DF910AE59EE27");
        ...
        {
            entity.HasKey(e => e.MaXuatKho).HasName("PK__XUAT_KHO__36F544112A26A70F");
